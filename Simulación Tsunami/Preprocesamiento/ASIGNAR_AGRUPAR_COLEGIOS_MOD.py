...
def agrupar_personas_2(familias = colegios,filtro = 'EE'):
  ...
  for key,grouped in familias.groupby(filtro):
    ...
    columnas = [indices,id_zona,id_manzent,nviv,hombres,mujeres,edad_0a5,edad_6a14,edad_15a64,edad_65ymas,casa,depto,o_d,ee,num_personas,geometry]
